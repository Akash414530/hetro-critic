    ...
    <>
      ...
      <div className="all">
        ...
        <div className="about-content">
          <h2>Introduction</h2>
          <p>
            Welcome to Hetrocritic! These terms and conditions outline the rules
            and regulations for the use of Hetrocritic&apos;s Website, located at
            www.Hetrocritic.com.
          </p>

          <h2>Intellectual Property Rights</h2>
          <p>
            Other than the content you own, under these Terms, Hetrocritic and/or
          ...
          <h2>Disclaimer</h2>
          <p>
            This Website is provided &quot;as is,&quot; with all faults, and Hetrocritic
          ...
          <p>
            Hetrocritic reserves the right to modify these Terms at any time. We
