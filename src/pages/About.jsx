  ...
  return (
    <>
      ...
      <div className="all">
        ...
        >
          <p>
            Welcome to <strong>HetroCritic</strong>!
          </p>

          <p>
            At HetroCritic, we&apos;re passionate about games. From the latest
            ...
            HetroCritic combines a love for gaming with professional journalism to
          ...
          <h2>Our Team</h2>
          <p>
            HetroCritic is powered by a diverse team of writers and reviewers, each
          ...
          <p>
            ...
            what make HetroCritic a vibrant and inclusive space for all gamers.
          </p>

          <p>
            Thank you for visiting HetroCritic. Let&apos;s explore the world of
            gaming together!
          </p>
        </div>
      </div>
